...
app.get("/api/users-all/apply", (req, res) => {
      ...
      experience: [
        {
          ...
          experienceDate: "2021-01-01",
          experienceText:
            "Worked as a software engineer in a technology company",
        },
      ],
      ...
      experience: [
        {
          ...
          experienceDate: "2018-01-01",
          experienceText:
            "Worked as a graphic design intern in a design agency",
        },
      ],
  ...
  console.log(123);
  res.status(200).json(userLogin.filter((user) => user.isSend));
});
